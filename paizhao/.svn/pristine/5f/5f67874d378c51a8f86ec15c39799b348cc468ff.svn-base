define('wap-huipai:global/utility/index', function(require, exports, module) {
  ...
  var cookie = require.syncLoad('wap-huipai:global/cookie/index');
  var ua = require.syncLoad('wap-huipai:global/ua/index');
  ...
  function program1(depth0,data) {
    ...
    return buffer;
      ...
      loading : function(options)
      {
          ...
          var loading_obj = layer.open({
                  type: 1
                  ,content: '<i class="loading"></i><p class="tc mt5">加载中</p>',
                  shade: false, //不显示遮罩
                  style : 'background:rgba(0,0,0,.5);text-align:center;color:#fff;',
                  skin: 'paizhao_loading'
           });
          return loading_obj;
      },
      /**
