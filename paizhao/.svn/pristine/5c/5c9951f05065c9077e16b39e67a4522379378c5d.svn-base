define('wap-huipai:global/list/list', function(require, exports, module) {
  ...
  var abnormal = require.syncLoad('wap-huipai:global/abnormal/index');
  ...
  { 
      ...
      self.lz_params = options.lz_params || {};
      //自定义无数据处理提示
