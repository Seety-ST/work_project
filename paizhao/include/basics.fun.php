<?php
    ...
    function mall_get_admin_menu($yue_login_id,$menu_id='')
    {
		...
		if(!in_array($menu_id,array('admin_menu_paizhao')))
		{
			$menu_id = 'admin_menu_paizhao';
		}
...
//											break;
    ...
    {
        $admin_entrance_menu_config = pai_mall_load_config('admin_entrance_menu');
...
//					$ip = mall_get_ip();
//					$ip_config = pai_mall_load_config('admin_ip');
...
//    $ary['selected'] = 2; 可以传数组array(1,2)达到复选效果
    ...
    function mall_get_admin_menu_v2()
    {
        ...
        $menu_config = pai_mall_paizhao_load_config('admin_menu_paizhao');
