define('pc-huipai:global/lazyload/lazyload', function(require, exports, module){ /**
...
LazyLoading.prototype =
{
    ...
    freshELE : function(con){
        ...
        var $ele_arr = $(con).find('['+self.flag+']');

        var map = [];

        $ele_arr.each(function(i,obj)
        {
            var url = $(obj).attr(self.flag);
    ...
    loadImage : function (el,options) 
    {
        ...
        var img = new Image();
        var src = el.getAttribute(self.flag);
            // self = this;
        ...
        self.img_ready(src,
        {
            load : function()
            {
                ...
                self._st = setTimeout(function()
                {
                    ...
                    $(el).addClass('loaded').removeAttr(self.flag);
                },500);
    ...
    {
        var self = this;
        var imgSrc = imgObjImg.getAttribute(self.flag);
        ...
        var imgWidth = imgSrcObj.width || setObjWidth;
        var imgHeight = imgSrcObj.height || setObjHeigth;
    ...
    get_yue_img_size_from_url : function (url)
    {
        ...
        if (m&&m[1])
        {
            ...
            if (img_size_arr instanceof Array) 
            {
                if(img_size_arr[1])
                {
