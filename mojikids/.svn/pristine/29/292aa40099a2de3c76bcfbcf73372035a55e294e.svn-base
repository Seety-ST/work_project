define('wap-kids:global/app/index', function(require, exports, module) {
  ...
  */
  ...
  var App = {
    ...
    * 扫二维码
    */
  	qrcodescan: function qrcodescan(options) {
    ...
    * @param callback
    */
  	check_login: function check_login(callback) {
  
  		appBridge.callHandler(prefix + 'info.login', {}, function (poco_id, locationid) {
    ...
    */
  	waplogin: function waplogin(options) {
  		var self = this;
    ...
    * @param callback
    */
  	get_chat_info: function get_chat_info(callback) {
  		var self = this;
    ...
    * @param success
    */
  	get_login_info: function get_login_info(success) {
  		var self = this;
    ...
    * @param params
    */
  	wxpay: function wxpay(params, callback) {
  		var self = this;
    ...
    * @return {[type]}            [description]
    */
  	unionpay: function unionpay(params, callback) {
  		var self = this;
  		...
  		appBridge.callHandler(prefix + 'function.unionpay', params, function (data) {
    ...
    * @param callback
    */
  	upload_img: function upload_img(type, params, callback) {
  		var self = this;
    ...
    * 打开聊天列表
    */
  	show_chat_list: function show_chat_list() {
  		alert('Error:methods is undefined');
  		return true;
  	},
  	/**
    ...
    * @param data
    */
  	show_alumn_imgs: function show_alumn_imgs(data) {
  		var data = data || {};
    ...
    * @param callback
    */
  	get_netstatus: function get_netstatus(callback) {
    ...
    * 传入参数：
      ...
      tokensecret：
    */
  	sso_login: function sso_login(params, callback) {
    ...
    *
    */
  	call_phone: function call_phone(params, callback) {
  		appBridge.callHandler(prefix + 'function.callphone', params, function (data) {
  			if (typeof callback == 'function') {
  				callback.call(this, data);
  			}
  		});
  	},
  	get_gps: function get_gps(params, callback) {
  		alert('Error:methods is undefined');
  		return true;
  	},
  	set_setting: function set_setting(params, callback) {
  		alert('Error:methods is undefined');
  		return true;
  	},
  	get_setting: function get_setting(params, callback) {
  		alert('Error:methods is undefined');
  		return true;
  	},
  	/**
    ...
    */
  	...
  	show_bottom_bar: function show_bottom_bar(show) {
  		alert('Error:methods is undefined');
  		return true;
  	},
    ...
    * 获取app信息 主要用于显示红点
    */
  	app_info: function app_info(callback) {
    ...
    * @param callback
    */
  	switchtopage: function switchtopage(options, callback) {
  		console.log('App switchtopage');
  
  		appBridge.callHandler(prefix + 'function.switchtopage', options, function (data) {
  			console.log(data);
    ...
    * @param callback
    */
  	share_card: function share_card(options, callback) {
  		var self = this;
  	...
  	analysis: function analysis(tj_type, options, callback) {
  		alert('Error:methods is undefined');
  		return true;
  	},
  	/**
    ...
    * @param params
    */
  	nav_to_app_page: function nav_to_app_page(params) {
  		alert('Error:methods is undefined');
  		return;
  	},
  	/**
    ...
    */
  	openlink: function openlink(url) {
  		...
  		appBridge.callHandler(prefix + 'function.openlink', { url: url }, function (data) {
    ...
    * @param callback
    */
  	openttpayfinish: function openttpayfinish(callback) {
  		console.log('App ttpayfinish');
  
  		appBridge.callHandler(prefix + 'function.ttpayfinish', {}, function (data) {
  			console.log(data);
    ...
    * @param callback
    */
  	close_webview: function close_webview(callback) {
  		console.log('App close_webview');
  
  		appBridge.callHandler(prefix + 'function.close', {}, function (data) {
  			console.log(data);
    ...
    * code：0000-登陆成功，1001-取消
      ...
      city：城市名
    */
  	show_selectcity: function show_selectcity(options, callback) {
  		console.log('App selectcity');
  
  		appBridge.callHandler(prefix + 'function.selectcity', options, function (data) {
  			console.log(data);
    ...
    * 传入参数：
    ...
    index：跳到哪一张二维码
      * @param callback
    */
  	qrcodeshow: function qrcodeshow(qrcodes, index, callback) {
  		console.log('App qrcodeshow');
  
  		index = index || 0;
  
  		appBridge.callHandler(prefix + 'function.qrcodeshow', { qrcodes: qrcodes, index: index }, function (data) {
  			console.log(data);
    ...
    */
  	showtopmenu: function showtopmenu(is_show, options, callback) {
  		...
  		appBridge.callHandler(prefix + 'function.showtopbar', options, function (data) {
  			console.log(data);
    ...
    * @return {[type]}
    */
  	payfinish: function payfinish(options, callback) {
  		options = options || {};
  
  		appBridge.callHandler(prefix + 'function.payfinish', options, function (data) {
  			console.log(data);
    ...
    * @return {[type]}            [description]
    */
  	open_paypage: function open_paypage(options, callback) {
  		options = options || {};
  
  		console.log('==== open_paypage options ====');
  		console.log(options);
  
  		appBridge.callHandler(prefix + 'function.pay', options, function (data) {
  			console.log(data);
