    ...
    var cookie_obj = {
        ...
        set: function(name, val, options) {
            ...
            var text = String(options.encode ? encode(val) : val),
                ...
                domain = options.domain || yue_domain, // 有效域名
                path = options.path || yue_path, // 有效路径
 ...
 * @return {[type]}         [description]
 */
var open_location = function(options)
{
    options = options || {};
    ...
    else
    {
        ...
        var default_gaode_params = {
            ...
            zoom: 18, // 地图缩放级别,整形值,范围从1~28。默认为最大
        };
 ...
 * @return mixed
 */
var new_yueyue_resize_act_img_url = function(img_url, size = '')
{
    var size_str = '';
...
var Dialog =  require.syncLoad(__moduleId('/modules/widget/dialog/index'));
var Loading =  require.syncLoad(__moduleId('/modules/widget/loading/index'));
