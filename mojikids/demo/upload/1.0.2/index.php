<?php
include_once('/disk/data/htdocs232/poco/mojikids/fe_include/common.inc.php');
// 引用头部、底部、统计
...
// 读取模板
$tpl = getSmartyTemplate('demo.tpl.htm', '/disk/data/htdocs232/poco/mojikids/demo/upload/1.0.2/',false, $clear_cache);
