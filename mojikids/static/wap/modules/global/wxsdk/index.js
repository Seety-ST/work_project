define('wap-kids:global/wxsdk/index', function(require, exports, module) {
      ...
      $el.on(upload_trigger_str, function () {
          if (choosen_list.length != 0) {
              WeiXinSDK.upload_imgs({
                  ...
                  success_single: function success_single(resa, index) {
