define('wap-kids:widget/popup/extend', function(require, exports, module) {
  ...
  !function (e, t) {
    "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) && "object" == (typeof module === "undefined" ? "undefined" : _typeof(module)) ? module.exports = t(Vue) : "function" == typeof define && define.amd ? define("VuePopup", ["vue"], t) : "object" == (typeof exports === "undefined" ? "undefined" : _typeof(exports)) ? exports.VuePopup = t(Vue) : e.VuePopup = t(e.vue);
    ...
    return function (e) {
      ...
      t.default = {
        ...
        beforeMount: function beforeMount() {
          this._popupId = "popup-" + a++, r.default.register(this._popupId, this);
        },
          ...
          doOpen: function doOpen(e) {
            if (!this.$isServer && (!this.willOpen || this.willOpen()) && !this.opened) {
              ...
              var t = h(this.$el),
                  o = e.modal,
                  n = e.zIndex;
              if (n && (r.default.zIndex = n), o && (this._closing && (r.default.closeModal(this._popupId), this._closing = !1), r.default.openModal(this._popupId, r.default.nextZIndex(), t, e.modalClass, e.modalFade), e.lockScroll)) {
                this.bodyOverflow || (this.bodyPaddingRight = document.body.style.paddingRight, this.bodyOverflow = document.body.style.overflow), f = p();
                var i = document.documentElement.clientHeight < document.body.scrollHeight;
                f > 0 && i && (document.body.style.paddingRight = f + "px"), document.body.style.overflow = "hidden";
              }
      ...
      var i = o(0),
        ...
        if (!l.default.prototype.$isServer) {
          var e = u.modalDom;
          return e ? d = !0 : (d = !1, e = document.createElement("div"), u.modalDom = e, e.addEventListener("touchmove", function (e) {
        ...
        openModal: function openModal(e, t, o, n, i) {
          if (!l.default.prototype.$isServer && e && void 0 !== t) {
            this.modalFade = i;
            ...
            var p = r();
            if ((0, s.addClass)(p, "v-modal"), this.modalFade && !d && (0, s.addClass)(p, "v-modal-enter"), n) {
            ...
            }, 200), o && o.parentNode && 11 !== o.parentNode.nodeType ? o.parentNode.appendChild(p) : document.body.appendChild(p), t && (p.style.zIndex = t), p.style.display = "", this.modalStack.push({
              id: e,
              zIndex: t,
              modalClass: n
            });
        ...
        closeModal: function closeModal(e) {
          ...
          0 === t.length && (this.modalFade && (0, s.addClass)(o, "v-modal-leave"), setTimeout(function () {
            0 === t.length && (o.parentNode && o.parentNode.removeChild(o), o.style.display = "none", u.modalDom = void 0), (0, s.removeClass)(o, "v-modal-leave");
          }, 200));
        }
      };
      !l.default.prototype.$isServer && window.addEventListener("keydown", function (e) {
